            ...
            <main class="col-md-11 ">
                ...
                <div class="container backup">
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <form action="{{ route('admin.updatefont') }}" method="post">
                            @csrf
                            <div class=" d-flex">
                    ...
                    <div class="row my-3 gx-4 gy-3 p-2 flex-lg-nowrap">
                                ...
                                <div>
                                    <div class="d-flex  mb-4 ">
                                        ...
                                        <div class="number-input">
                                            <input type="" id="number" value="{{$seettings->font_h1}}" name="h1"
                                                min="1">
                                            <div class="controls">
                                    ...
                                    <div class="d-flex mt-1 mb-4 ">
                                        ...
                                        <div class="number-input">
                                            <input type="" name="h2" id="number" value="{{$seettings->font_h2}}"
                                                min="1">
                                            <div class="controls">
                                                {{-- <button onclick="increase()"><i class="fas fa-chevron-up"></i></button>
                                                <button onclick="decrease()"><i
                                    ...
                                    <div class="d-flex mt-1 mb-4 ">
                                        ...
                                        <div class="number-input">
                                            <input type="" name="h4" id="number" value="{{$seettings->font_h4}}"
                                                min="1">
                                            <div class="controls">
                                                {{-- <button onclick="increase()"><i
                                                        class="fas fa-chevron-up"></i></button>
                                ...
                                <div class="font-color">
                                    ...
                                    <div class="d-flex mt-1 mb-4 paragraph-font">
                                        ...
                                        <div class="number-input me-5">
                                            <input type="" name="para" id="number" value="54"
                                                min="1">
                                            <div class="controls">
                                                {{-- <button onclick="increase()"><i
                                                        class="fas fa-chevron-up"></i></button>
                        ...
                        <div class="col-12 col-md-12 col-lg-6 shadow rounded-4 p-4 ms-lg-4 ms-0 ">
                            ...
                            <div class="input-group mb-3 w-100 ">
                                <input name="body" type="text" class="form-control w-75"
                                    placeholder="#ffffff">
                                <input type="color" name="body"
                                    class="form-control form-control-color border-black" id="exampleColorInput"
                                    value="#FFFFFF" title="Choose your color">
                            </div>
                            <p class="">Font Heading</p>
                            <div class="input-group mb-3 w-100 ">
                                <input name="heading" type="text" class="form-control w-75"
                                    placeholder="#17253F">
                            ...
                            <p class="">Paragraph</p>
                            <div class="input-group mb-3 w-100 ">
                                <input name="paracolor" type="text" class="form-control w-75"
                                    placeholder="#949494">
                            ...
                            <div class="d-flex justify-content-between w-100">
                                <div class="w-75 me-4">
                                    ...
                                    <div class="input-group w-100 ">
                                        <input name="button" type="text" class="form-control w-75 "
                                            placeholder="#1876F1">
