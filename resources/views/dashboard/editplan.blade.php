                ...
                <div class="container-fluid container-lg backup pb-5">
                    <div class="d-flex justify-content-between mt-3">
                        <div class=" pb-2 mb-1 create_new_plan">
                            <a href="/admin/subscriptionplan.html" target="_self" class="me-3 "><i
                                    class="fa-solid fa-chevron-left me-3"></i>Create New Plan</a>
                        </div>
                    </div>
                    <div class=" shadow  rounded-4 overflow-hidden p-4 border mb-3 mt-3 submanagment">
                                ...
                                <form action="{{ route('plans.update', $plan->id) }}" method="post">
                                    ...
                                    <div class="mt-2 w-75">
                                        ...
                                        <input type="text" placeholder="Type here" name="name"
                                            value="{{ $plan->name }}" id="" class="form-control">
                                    </div>
                                    <div class="my-4 w-75">
                                        <label for="exampleFormControlTextarea1"
                                            class="form-label">Description</label>
                                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3">{{ $plan->description }}</textarea>
                                    </div>
                                    <div>
                        ...
                        <div class="mb-3 w-75">
                            ...
                            <div class="input-group w-100">
                                <input value="{{ $plan->price }}" name="price" type="number"
                                    class="form-control">
                        ...
                        <select name="status" style="margin-bottom:20px" class="form-select w-75">
                            ...
                            <option value="disactive" {{ $plan->status === 'disactive' ? 'selected' : '' }}>Inactive
                            </option>
                        </select>
