                        ...
                        <div class="col-md-6">
                            <form action="{{ route('user.update' , $user->id) }}" method="post">
                                ...
                                <div class="mb-3 w-75">
                                    ...
                                    <input value="{{$user->fname}}" type="text" name="fname" class="form-control" id="fname" placeholder="Enter First Name" required>
                                </div>
                            
                                <!-- Last Name -->
                                <div class="mb-3 w-75">
                                    <label for="lname" class="form-label">Last Name</label>
                                    <input  value="{{$user->lname}}"type="text" name="lname" class="form-control" id="lname" placeholder="Enter Last Name" required>
                                </div>
                            
                                <!-- Email -->
                                <div class="mb-3 w-75">
                                    <label for="email" class="form-label">Email Address</label>
                                    <input value="{{$user->email}}" type="email" name="email" class="form-control" id="email" placeholder="Enter Email" required>
                                </div>
