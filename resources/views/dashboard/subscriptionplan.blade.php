            ...
            <main class="col-md-11 ">
                ...
                <div class="d-flex justify-content-between overflow-hidden  border-bottom  nav-create py-1">
                    ...
                    <div class="info_nav  d-flex align-self-center mt-3 ms-lg-3 ms-md-5 ms-1">
                        ...
                        <a href="{{route('plans.index')}}"><p class="ms-4">Plan & Pricing</p></a>  
                    </div>
                ...
                <div class="img_managment2 position-relative">
                    <img src="/admin/assets/Vector (5).png" class="position-absolute top-0" alt="">
                        ...
                        <button class="button_Adduser position-absolute z-1 ">Create New Plan</button>
                ...
                <div class="container-fluid container-lg">
                    <div class="mt-4 all-sub">
                        <a href="/admin/submanagment.html"> <h2>All Plans</h2>  </a>
                                ...
                                <tbody>
                                  <tr class="pt-5">
                                    <td class="p-0 p-md-3 d-md-flex">
                                         <img src="/admin/assets/image (1).png" class="img_logo mt-sm-2" alt="employee">
                                        <p class="mt-3 mt-lg-4 mt-sm-1 ms-2">#5 - Username</p>
                                    </td>
                                        <td class="sub-line "><p>Basic</p> <p>$2.99 / Monthly</p> </td>
                                        <td class="pe-md-5 pe-0 "> 
                                  ...
                                  <tr class="pt-5">
                                    <td class="p-0 p-md-3 d-md-flex">
                                         <img src="/admin/assets/image (2).png" class="img_logo mt-sm-2" alt="employee">
                                        <p class="mt-3 mt-lg-4 mt-sm-1 ms-2">#4 - Username</p>
                                    </td>
                                        <td class=" sub-line"><p>Standard</p> <p>$250 / Yearly</p> </td>
                                        <td class="pe-md-5 pe-0 "> 
                                            <button class="button_admin">Completed</button>
                                        </td>
                                        <td class="sub-line"><p>$150.00</p>
                                        <p>25 Dec, 2024</p></td>
                                    <td> 
                                        26 Dec, 2024
                                    </td>
                                  ...
                                  <tr class="pt-5">
                                    <td class="p-0 p-md-3 d-md-flex">
                                         <img src="/admin/assets/image (3).png" class="img_logo mt-sm-2" alt="employee">
                                  ...
                                  <tr class="pt-5">
                                    <td class="p-0 p-md-3 d-md-flex">
                                         <img src="/admin/assets/image (4).png" class="img_logo mt-sm-2" alt="employee">
                                        <p class="mt-3 mt-lg-4 mt-sm-1 ms-2">#5 - Username</p>
                                    </td>
                                        <td class=" sub-line"><p>Premium</p> <p>$2.99 / Monthly</p></td>
                                        <td class="pe-md-5 pe-0 "> 
                                            <button class="button_admin_sub ms-3">Active</button>
                                        </td>
                                        <td class="sub-line"><p>$150.00</p>
                                  ...
                                  <tr class="pt-5">
                                    <td class="p-0 p-md-3 d-md-flex">
                                         <img src="/admin/assets/image (5).png" class="img_logo mt-sm-2" alt="employee">
                                        <p class="mt-3 mt-lg-4 mt-sm-1 ms-2">#5 - Username</p>
                                    </td>
                                        <td class="sub-line "> <p>Basic</p> <p>$2.99 / Monthly</p> </td>
                                        <td class="pe-md-5 pe-0 "> 
   ...
   document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".button_admin_sub").forEach(button => {
        button.addEventListener("click", function () {
            ...
            console.log("Plan ID:", planId); // احصل على ID الخاص بالخطة
            let button = this;

            fetch(`plans/edit/${planId}`, { // المسار الصحيح حسب Route::resource
                method: "PATCH", // الطريقة الصحيحة لتحديث البيانات
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRF-TOKEN": document.querySelector('meta[name="csrf-token"]').getAttribute("content")
                },
                body: JSON.stringify({}) // يمكن تمرير بيانات إضافية هنا
            })
            .then(response => response.json())
            .then(data => {
                if (data.message) {
                    // تبديل النص بناءً على الحالة الجديدة
                    button.textContent = button.textContent === "active" ? "disactive" : "active";
                }
            })
